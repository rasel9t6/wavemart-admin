...
export const config = {
  matcher: [
     ...
     */
    '/((?!api/auth|api/categories|api/[..categorySlug]|api/products|api/[productId]|api/search/[query]|api/orders|api/[orderId]|api/customers|api/users|_next/static|_next/image|favicon.ico).*)',
  ],
};
